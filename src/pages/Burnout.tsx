  ...
  return (
    <div>
      ...
      <article>
        <Parallax speed={-4}>
          <div className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
            <p>
              ...
              free medical treatment to individuals with no health insurance,
              the Free Clinic Movement.
            </p>
            <br />
            <p>
              These clinics were run by volunteers, a mix of nurses, doctors,
              and students, who worked after their regular workday ended. Due to
              the prevalence of drug-related issues during that time, the
              clinics often treated drug related illnesses, and at the time, the
              term "burnout" was used to describe the physical effects of
              chronic drug use.
            </p>
          </div>
        </Parallax>
        ...
        <div className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          <p>
            ...
            <b className={`${styles.bold}`}>
              ...
              personally experienced burnout, are uncertain if how you’re
          ...
          <div className="w-fit mx-auto mt-4 bg-cyan-800 pt-1 pb-4 px-10 rounded-2xl">
            <p className="text-neutral-200 text-lg my-6">
              <b>On this page</b>
            </p>
            <ul className="text-neutral-200 font-normal leading-10 ">
              <li>
        ...
        <div className=" mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          <p>
            Only recently has the World Health Organisation, WHO, added burnout
            to it’s characterisation system for illnesses, the ICD-11, in 2019.
          ...
          <p>
            ...
            that it only manifests in the workplace setting, highlighting the
            role of employers and organizations as essential factors in its
            development. Burnout being the consequence of a malfunctioning
            system.
          </p>
          <br />
          <p>
            Going through stressful periods at work, like working extra to meet
            a deadline, is unavoidable at times. However, burnout arises when
            this stress becomes a constant. It follows that to avoid burnout and
            help burnt out people, not only the individuals must be helped, but
            the workplace as well.
          </p>

          <br />
          <p>
            To not only focus on the negative, it is interesting to note that
            job engagement, defined as
            <blockquote className="p-4 my-4 border-l-4 border-gray-500 bg-cyan-800">
              <p className="text-base sm:text-xl italic font-medium leading-relaxed text-neutral-200">
        ...
        <div className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          <p>
            Many associate burnout with the feeling of being exhausted, not
            having the energy to accomplish basic tasks. But exhaustion is but
            one of the facets of burnout.
          </p>
            ...
            <div className={`${styles.icon_text_responsivity}`}>
              ...
              <p>
                ...
                <div className="border-2 rounded-md p-2 my-2 border-sky-800 bg-[#397A9D]">
                  ...
                  straight, feeling fed up with work and just wanting to go
                  home.
                </div>
              </p>
            </div>
            ...
            <div className={`${styles.icon_text_responsivity}`}>
              ...
              <p>
                ...
                <div className="border-2 rounded-md p-2 my-2 border-red-800 bg-[#AD4949]">
                  Typical feelings of cynicism are negativity or hostility
                  towards the work and coworkers, only doing the bare minimum.
                  Not seeing the value in the work anymore.
                </div>
              </p>
            </div>
          </Parallax>
          <Parallax speed={4}>
            <div className={`${styles.icon_text_responsivity}`}>
              ...
              <p>
                The inefficacy component of burnout represents the
                self-evaluation dimension. It refers to feelings of incompetence
                and a lack of achievement and productivity in one’s work. It can
                also exacerbate feelings of Imposter Syndrome.
        ...
        <p className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          Burnout is associated with several forms of negative responses to
          work, including{" "}
          <b className={`${styles.bold}`}>
            job dissatisfaction, low commitment to the organization,
            absenteeism, intention to quit the job, and employee turnover
          </b>
          ...
          . <b className={`${styles.bold}`}>Poor job performance </b>is one of
          the most significant consequences of burnout in the workplace, which
        ...
        <p className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          Research into high performing organisations in software development
          has shown that employee engagement and satisfaction are indicative of
          employee loyalty and identity, they can help reduce the likelihood of
          burnout while driving key organizational outcomes such as
          profitability, productivity, and market share. In fact, employees in
          high-performing teams were twice as likely to recommend their
          organization to a friend as a great place to work.
        </p>
        <p className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          ...
          utilize customer feedback, as well as the ability of teams to
          visualize and understand the development process from start to finish.
          Engagement is also linked to how much employees align with their
          workplace's values and goals, and how much effort they're willing to
          put in to ensure the organization's success.
        </p>
        ...
        <p className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          Maslach's research resulted in the identification of six key domains
          in worklife, as situational predictors of burnout. The key idea is
          that finding a good fit between the person and their job is essential.
          This model identifies areas of work that can impact a person's job
        ...
        <div className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          <div className={`${styles.icon_text_responsivity}`}>
            ...
            <p>
              Having too much to do in too little time and with limited
              resources can lead to{" "}
              <span className="bg-sky-800 p-1 rounded-md leading-8">
                exhaustion.
              </span>{" "}
              It's not just the amount of work that matters, but also the
              quality of the work. Doing work that is outside the scope of one's
              job can be particularly draining. Work overload can deplete a
              person's energy, but with the chance to recover, the energy can be
              recharged keeping exhaustion at bay, without time to recover the
        ...
        <div className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          <div className={`${styles.icon_text_responsivity}`}>
            ...
            <div>
              <p>
                It is vital for job satisfaction and commitment that workers
                have the ability to influence decisions on how they perform
                their tasks, exercise professional autonomy, and access
                necessary resources to do their job effectively. Problematic
                aspects of job control arises when there is role conflict and
                role ambiguity.
              </p>
              <br />
              <p>
        ...
        <div className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          <div className={`${styles.icon_text_responsivity}`}>
            ...
            <p>
              ...
              are monetary, social, or intrinsic, match our expectations.
              Research has found that inadequate rewards can make people more
              susceptible to burnout. Lack of recognition from those around us
              are associated with feelings of{" "}
          ...
          <div className={`${styles.icon_text_responsivity}`}>
            ...
            <div>
              <p>
                ...
                , reflecting the impact that supervisors have on workload.
                Social support in general is associated with higher engagement.
              </p>
              <br />
              <p>
                In addition, a sense of community in the workplace is important
                as well, as it has been found to alleviate feelings of
                inequality. Conversely, if workplace relationships become toxic,
        ...
        <div className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          <div className={`${styles.icon_text_responsivity}`}>
            ...
            <p>
              ...
              community. On the contrary, for decisions to be fair people need
              to present their arguments and be treated with respect and
              politeness.
            </p>
          </div>
        </div>
          ...
          <div className={`${styles.icon_text_responsivity}`}>
            ...
            <div>
              <p>
                ...
                workplace. Value conflicts can be making a trade-off between
                work you want to do, and the actual work; it can be having to do
                things on the job that don’t go with their own values or being
                caught between conflicting values in a workplace.
              </p>
              <br />
              <p>
                Research has found that value conflicts and work overload are
                the two most relevant factors for employees experience of
                burnout.
              </p>
            </div>
          </div>
        ...
        <h3
          ...
          className="mx-auto w-3/4 lg:w-2/4 text-neutral-200 font-bold capitalize"
        >
        ...
        <p className="mx-auto text-cyan-100 my-4 w-3/4 lg:w-2/4 place-items-center">
          ...
          Leaders who limit work in process and eliminate roadblocks for the
          team.
        </p>
        <h3
          id="fourth_header_sub_1"
